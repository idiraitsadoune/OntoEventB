...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Unit Name</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see pivotmodel.PivotmodelPackage#getUnitName()
 * @model
 * @generated
 */
public enum UnitName implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	DEGREE_CELSIUS(22, "DEGREE_CELSIUS", "DEGREE_CELSIUS"),
	 ...
	 * @ordered
	 */
	public static final int DEGREE_CELSIUS_VALUE = 22;
	...
	/**
	 * An array of all the '<em><b>Unit Name</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final UnitName[] VALUES_ARRAY =
		new UnitName[] {
			METRE,
			GRAM,
			SECOND,
	...
	/**
	 * A public read-only list of all the '<em><b>Unit Name</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<UnitName> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Unit Name</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static UnitName get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			UnitName result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Unit Name</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static UnitName getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			UnitName result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Unit Name</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static UnitName get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private UnitName(int value, String name, String literal) {
		this.value = value;
		this.name = name;
