...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Prefixe Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see pivotmodel.PivotmodelPackage#getPrefixeType()
 * @model
 * @generated
 */
public enum PrefixeType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Prefixe Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final PrefixeType[] VALUES_ARRAY =
		new PrefixeType[] {
			EXA,
			PETA,
			TERA,
	...
	/**
	 * A public read-only list of all the '<em><b>Prefixe Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<PrefixeType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Prefixe Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static PrefixeType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			PrefixeType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Prefixe Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static PrefixeType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			PrefixeType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Prefixe Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static PrefixeType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private PrefixeType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
