 ...
 * </p>
 * <ul>
 *   <li>{@link pivotmodel.impl.DataTypeDefinitionImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DataTypeDefinitionImpl extends MinimalEObjectImpl.Container implements DataTypeDefinition {
	...
	protected EClass eStaticClass() {
		return PivotmodelPackage.Literals.DATA_TYPE_DEFINITION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PivotmodelPackage.DATA_TYPE_DEFINITION__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PivotmodelPackage.DATA_TYPE_DEFINITION__NAME:
				return getName();
		}
