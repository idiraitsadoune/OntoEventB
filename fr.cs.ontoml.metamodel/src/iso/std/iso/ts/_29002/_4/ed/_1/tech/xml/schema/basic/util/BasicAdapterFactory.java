...
public class BasicAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link iso.std.iso.ts._29002._4.ed._1.tech.xml.schema.basic.InternationalTextType <em>International Text Type</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link iso.std.iso.ts._29002._4.ed._1.tech.xml.schema.basic.LanguageStringType <em>Language String Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
