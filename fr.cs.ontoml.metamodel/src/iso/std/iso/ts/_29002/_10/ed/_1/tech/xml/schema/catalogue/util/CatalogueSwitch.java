...
public class CatalogueSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CataloguePackage.CATALOGUE_TYPE: {
				CatalogueType catalogueType = (CatalogueType)theEObject;
				T result = caseCatalogueType(catalogueType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CataloguePackage.DOCUMENT_ROOT: {
				DocumentRoot documentRoot = (DocumentRoot)theEObject;
				T result = caseDocumentRoot(documentRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CataloguePackage.ITEM_TYPE: {
				ItemType itemType = (ItemType)theEObject;
				T result = caseItemType(itemType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CataloguePackage.PROPERTY_VALUE_TYPE: {
	 ...
	 * @generated
	 */
	public T caseCatalogueType(CatalogueType object) {
		return null;
	}
