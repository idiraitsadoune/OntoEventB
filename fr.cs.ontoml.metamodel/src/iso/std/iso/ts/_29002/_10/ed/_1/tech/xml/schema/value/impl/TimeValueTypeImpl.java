 ...
 * </p>
 * <ul>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.TimeValueTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeValueTypeImpl extends MinimalEObjectImpl.Container implements TimeValueType {
	/**
	...
	protected EClass eStaticClass() {
		return ValuePackage.Literals.TIME_VALUE_TYPE;
	}
	...
	public void setValue(XMLGregorianCalendar newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.TIME_VALUE_TYPE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ValuePackage.TIME_VALUE_TYPE__VALUE:
				return getValue();
		}
