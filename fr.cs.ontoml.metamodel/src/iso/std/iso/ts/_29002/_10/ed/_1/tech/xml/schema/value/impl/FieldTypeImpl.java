 ...
 * </p>
 * <ul>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getStringValue <em>String Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getBagValue <em>Bag Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getBooleanValue <em>Boolean Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getComplexValue <em>Complex Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getCompositeValue <em>Composite Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getControlledValue <em>Controlled Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getCurrencyValue <em>Currency Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getDateValue <em>Date Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getDateTimeValue <em>Date Time Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getFileValue <em>File Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getIntegerValue <em>Integer Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getItemReferenceValue <em>Item Reference Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getLocalizedTextValue <em>Localized Text Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getMeasureQualifiedNumberValue <em>Measure Qualified Number Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getMeasureRangeValue <em>Measure Range Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getMeasureSingleNumberValue <em>Measure Single Number Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getNullValue <em>Null Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getRationalValue <em>Rational Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getRealValue <em>Real Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getSequenceValue <em>Sequence Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getSetValue <em>Set Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getTimeValue <em>Time Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getYearMonthValue <em>Year Month Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getYearValue <em>Year Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.FieldTypeImpl#getPropertyRef <em>Property Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FieldTypeImpl extends MinimalEObjectImpl.Container implements FieldType {
	...
	protected EClass eStaticClass() {
		return ValuePackage.Literals.FIELD_TYPE;
	}
	...
	public NotificationChain basicSetStringValue(StringValueType newStringValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__STRING_VALUE, oldStringValue, newStringValue);
	...
	public void setStringValue(StringValueType newStringValue) {
		if (newStringValue != stringValue) {
			...
			if (stringValue != null)
				msgs = ((InternalEObject)stringValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__STRING_VALUE, null, msgs);
			if (newStringValue != null)
				msgs = ((InternalEObject)newStringValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__STRING_VALUE, null, msgs);
			msgs = basicSetStringValue(newStringValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__STRING_VALUE, newStringValue, newStringValue));
	}
	...
	public NotificationChain basicSetBagValue(BagValueType newBagValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__BAG_VALUE, oldBagValue, newBagValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setBagValue(BagValueType newBagValue) {
		if (newBagValue != bagValue) {
			NotificationChain msgs = null;
			if (bagValue != null)
				msgs = ((InternalEObject)bagValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__BAG_VALUE, null, msgs);
			if (newBagValue != null)
				msgs = ((InternalEObject)newBagValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__BAG_VALUE, null, msgs);
			msgs = basicSetBagValue(newBagValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__BAG_VALUE, newBagValue, newBagValue));
	}
	...
	public NotificationChain basicSetBooleanValue(BooleanValueType newBooleanValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__BOOLEAN_VALUE, oldBooleanValue, newBooleanValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setBooleanValue(BooleanValueType newBooleanValue) {
		if (newBooleanValue != booleanValue) {
			...
			if (booleanValue != null)
				msgs = ((InternalEObject)booleanValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__BOOLEAN_VALUE, null, msgs);
			if (newBooleanValue != null)
				msgs = ((InternalEObject)newBooleanValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__BOOLEAN_VALUE, null, msgs);
			msgs = basicSetBooleanValue(newBooleanValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__BOOLEAN_VALUE, newBooleanValue, newBooleanValue));
	}
	...
	public NotificationChain basicSetComplexValue(ComplexValueType newComplexValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__COMPLEX_VALUE, oldComplexValue, newComplexValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setComplexValue(ComplexValueType newComplexValue) {
		if (newComplexValue != complexValue) {
			...
			if (complexValue != null)
				msgs = ((InternalEObject)complexValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__COMPLEX_VALUE, null, msgs);
			if (newComplexValue != null)
				msgs = ((InternalEObject)newComplexValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__COMPLEX_VALUE, null, msgs);
			msgs = basicSetComplexValue(newComplexValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__COMPLEX_VALUE, newComplexValue, newComplexValue));
	}
	...
	public NotificationChain basicSetCompositeValue(CompositeValueType newCompositeValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__COMPOSITE_VALUE, oldCompositeValue, newCompositeValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCompositeValue(CompositeValueType newCompositeValue) {
		if (newCompositeValue != compositeValue) {
			...
			if (compositeValue != null)
				msgs = ((InternalEObject)compositeValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__COMPOSITE_VALUE, null, msgs);
			if (newCompositeValue != null)
				msgs = ((InternalEObject)newCompositeValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__COMPOSITE_VALUE, null, msgs);
			msgs = basicSetCompositeValue(newCompositeValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__COMPOSITE_VALUE, newCompositeValue, newCompositeValue));
	}
	...
	public NotificationChain basicSetControlledValue(ControlledValueType newControlledValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__CONTROLLED_VALUE, oldControlledValue, newControlledValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setControlledValue(ControlledValueType newControlledValue) {
		if (newControlledValue != controlledValue) {
			...
			if (controlledValue != null)
				msgs = ((InternalEObject)controlledValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__CONTROLLED_VALUE, null, msgs);
			if (newControlledValue != null)
				msgs = ((InternalEObject)newControlledValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__CONTROLLED_VALUE, null, msgs);
			msgs = basicSetControlledValue(newControlledValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__CONTROLLED_VALUE, newControlledValue, newControlledValue));
	}
	...
	public NotificationChain basicSetCurrencyValue(CurrencyValueType newCurrencyValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__CURRENCY_VALUE, oldCurrencyValue, newCurrencyValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCurrencyValue(CurrencyValueType newCurrencyValue) {
		if (newCurrencyValue != currencyValue) {
			...
			if (currencyValue != null)
				msgs = ((InternalEObject)currencyValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__CURRENCY_VALUE, null, msgs);
			if (newCurrencyValue != null)
				msgs = ((InternalEObject)newCurrencyValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__CURRENCY_VALUE, null, msgs);
			msgs = basicSetCurrencyValue(newCurrencyValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__CURRENCY_VALUE, newCurrencyValue, newCurrencyValue));
	}
	...
	public NotificationChain basicSetDateValue(DateValueType newDateValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__DATE_VALUE, oldDateValue, newDateValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDateValue(DateValueType newDateValue) {
		if (newDateValue != dateValue) {
			NotificationChain msgs = null;
			if (dateValue != null)
				msgs = ((InternalEObject)dateValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__DATE_VALUE, null, msgs);
			if (newDateValue != null)
				msgs = ((InternalEObject)newDateValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__DATE_VALUE, null, msgs);
			msgs = basicSetDateValue(newDateValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__DATE_VALUE, newDateValue, newDateValue));
	}
	...
	public NotificationChain basicSetDateTimeValue(DateTimeValueType newDateTimeValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__DATE_TIME_VALUE, oldDateTimeValue, newDateTimeValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDateTimeValue(DateTimeValueType newDateTimeValue) {
		if (newDateTimeValue != dateTimeValue) {
			...
			if (dateTimeValue != null)
				msgs = ((InternalEObject)dateTimeValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__DATE_TIME_VALUE, null, msgs);
			if (newDateTimeValue != null)
				msgs = ((InternalEObject)newDateTimeValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__DATE_TIME_VALUE, null, msgs);
			msgs = basicSetDateTimeValue(newDateTimeValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__DATE_TIME_VALUE, newDateTimeValue, newDateTimeValue));
	}
	...
	public NotificationChain basicSetFileValue(FileValueType newFileValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__FILE_VALUE, oldFileValue, newFileValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFileValue(FileValueType newFileValue) {
		if (newFileValue != fileValue) {
			NotificationChain msgs = null;
			if (fileValue != null)
				msgs = ((InternalEObject)fileValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__FILE_VALUE, null, msgs);
			if (newFileValue != null)
				msgs = ((InternalEObject)newFileValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__FILE_VALUE, null, msgs);
			msgs = basicSetFileValue(newFileValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__FILE_VALUE, newFileValue, newFileValue));
	}
	...
	public NotificationChain basicSetIntegerValue(IntegerValueType newIntegerValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__INTEGER_VALUE, oldIntegerValue, newIntegerValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIntegerValue(IntegerValueType newIntegerValue) {
		if (newIntegerValue != integerValue) {
			...
			if (integerValue != null)
				msgs = ((InternalEObject)integerValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__INTEGER_VALUE, null, msgs);
			if (newIntegerValue != null)
				msgs = ((InternalEObject)newIntegerValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__INTEGER_VALUE, null, msgs);
			msgs = basicSetIntegerValue(newIntegerValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__INTEGER_VALUE, newIntegerValue, newIntegerValue));
	}
	...
	public NotificationChain basicSetItemReferenceValue(ItemReferenceValueType newItemReferenceValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__ITEM_REFERENCE_VALUE, oldItemReferenceValue, newItemReferenceValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setItemReferenceValue(ItemReferenceValueType newItemReferenceValue) {
		if (newItemReferenceValue != itemReferenceValue) {
			...
			if (itemReferenceValue != null)
				msgs = ((InternalEObject)itemReferenceValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__ITEM_REFERENCE_VALUE, null, msgs);
			if (newItemReferenceValue != null)
				msgs = ((InternalEObject)newItemReferenceValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__ITEM_REFERENCE_VALUE, null, msgs);
			msgs = basicSetItemReferenceValue(newItemReferenceValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__ITEM_REFERENCE_VALUE, newItemReferenceValue, newItemReferenceValue));
	}
	...
	public NotificationChain basicSetLocalizedTextValue(LocalizedTextValueType newLocalizedTextValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__LOCALIZED_TEXT_VALUE, oldLocalizedTextValue, newLocalizedTextValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLocalizedTextValue(LocalizedTextValueType newLocalizedTextValue) {
		if (newLocalizedTextValue != localizedTextValue) {
			...
			if (localizedTextValue != null)
				msgs = ((InternalEObject)localizedTextValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__LOCALIZED_TEXT_VALUE, null, msgs);
			if (newLocalizedTextValue != null)
				msgs = ((InternalEObject)newLocalizedTextValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__LOCALIZED_TEXT_VALUE, null, msgs);
			msgs = basicSetLocalizedTextValue(newLocalizedTextValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__LOCALIZED_TEXT_VALUE, newLocalizedTextValue, newLocalizedTextValue));
	}
	...
	public NotificationChain basicSetMeasureQualifiedNumberValue(MeasureQualifiedNumberValueType newMeasureQualifiedNumberValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__MEASURE_QUALIFIED_NUMBER_VALUE, oldMeasureQualifiedNumberValue, newMeasureQualifiedNumberValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMeasureQualifiedNumberValue(MeasureQualifiedNumberValueType newMeasureQualifiedNumberValue) {
		if (newMeasureQualifiedNumberValue != measureQualifiedNumberValue) {
			...
			if (measureQualifiedNumberValue != null)
				msgs = ((InternalEObject)measureQualifiedNumberValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__MEASURE_QUALIFIED_NUMBER_VALUE, null, msgs);
			if (newMeasureQualifiedNumberValue != null)
				msgs = ((InternalEObject)newMeasureQualifiedNumberValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__MEASURE_QUALIFIED_NUMBER_VALUE, null, msgs);
			msgs = basicSetMeasureQualifiedNumberValue(newMeasureQualifiedNumberValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__MEASURE_QUALIFIED_NUMBER_VALUE, newMeasureQualifiedNumberValue, newMeasureQualifiedNumberValue));
	}
	...
	public NotificationChain basicSetMeasureRangeValue(MeasureRangeValueType newMeasureRangeValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__MEASURE_RANGE_VALUE, oldMeasureRangeValue, newMeasureRangeValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMeasureRangeValue(MeasureRangeValueType newMeasureRangeValue) {
		if (newMeasureRangeValue != measureRangeValue) {
			...
			if (measureRangeValue != null)
				msgs = ((InternalEObject)measureRangeValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__MEASURE_RANGE_VALUE, null, msgs);
			if (newMeasureRangeValue != null)
				msgs = ((InternalEObject)newMeasureRangeValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__MEASURE_RANGE_VALUE, null, msgs);
			msgs = basicSetMeasureRangeValue(newMeasureRangeValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__MEASURE_RANGE_VALUE, newMeasureRangeValue, newMeasureRangeValue));
	}
	...
	public NotificationChain basicSetMeasureSingleNumberValue(MeasureSingleNumberValueType newMeasureSingleNumberValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__MEASURE_SINGLE_NUMBER_VALUE, oldMeasureSingleNumberValue, newMeasureSingleNumberValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMeasureSingleNumberValue(MeasureSingleNumberValueType newMeasureSingleNumberValue) {
		if (newMeasureSingleNumberValue != measureSingleNumberValue) {
			...
			if (measureSingleNumberValue != null)
				msgs = ((InternalEObject)measureSingleNumberValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__MEASURE_SINGLE_NUMBER_VALUE, null, msgs);
			if (newMeasureSingleNumberValue != null)
				msgs = ((InternalEObject)newMeasureSingleNumberValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__MEASURE_SINGLE_NUMBER_VALUE, null, msgs);
			msgs = basicSetMeasureSingleNumberValue(newMeasureSingleNumberValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__MEASURE_SINGLE_NUMBER_VALUE, newMeasureSingleNumberValue, newMeasureSingleNumberValue));
	}
	...
	public NotificationChain basicSetNullValue(NullValueType newNullValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__NULL_VALUE, oldNullValue, newNullValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setNullValue(NullValueType newNullValue) {
		if (newNullValue != nullValue) {
			NotificationChain msgs = null;
			if (nullValue != null)
				msgs = ((InternalEObject)nullValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__NULL_VALUE, null, msgs);
			if (newNullValue != null)
				msgs = ((InternalEObject)newNullValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__NULL_VALUE, null, msgs);
			msgs = basicSetNullValue(newNullValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__NULL_VALUE, newNullValue, newNullValue));
	}
	...
	public NotificationChain basicSetRationalValue(RationalValueType newRationalValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__RATIONAL_VALUE, oldRationalValue, newRationalValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRationalValue(RationalValueType newRationalValue) {
		if (newRationalValue != rationalValue) {
			...
			if (rationalValue != null)
				msgs = ((InternalEObject)rationalValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__RATIONAL_VALUE, null, msgs);
			if (newRationalValue != null)
				msgs = ((InternalEObject)newRationalValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__RATIONAL_VALUE, null, msgs);
			msgs = basicSetRationalValue(newRationalValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__RATIONAL_VALUE, newRationalValue, newRationalValue));
	}
	...
	public NotificationChain basicSetRealValue(RealValueType newRealValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__REAL_VALUE, oldRealValue, newRealValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRealValue(RealValueType newRealValue) {
		if (newRealValue != realValue) {
			NotificationChain msgs = null;
			if (realValue != null)
				msgs = ((InternalEObject)realValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__REAL_VALUE, null, msgs);
			if (newRealValue != null)
				msgs = ((InternalEObject)newRealValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__REAL_VALUE, null, msgs);
			msgs = basicSetRealValue(newRealValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__REAL_VALUE, newRealValue, newRealValue));
	}
	...
	public NotificationChain basicSetSequenceValue(SequenceValueType newSequenceValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__SEQUENCE_VALUE, oldSequenceValue, newSequenceValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSequenceValue(SequenceValueType newSequenceValue) {
		if (newSequenceValue != sequenceValue) {
			...
			if (sequenceValue != null)
				msgs = ((InternalEObject)sequenceValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__SEQUENCE_VALUE, null, msgs);
			if (newSequenceValue != null)
				msgs = ((InternalEObject)newSequenceValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__SEQUENCE_VALUE, null, msgs);
			msgs = basicSetSequenceValue(newSequenceValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__SEQUENCE_VALUE, newSequenceValue, newSequenceValue));
	}
	...
	public NotificationChain basicSetSetValue(SetValueType newSetValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__SET_VALUE, oldSetValue, newSetValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSetValue(SetValueType newSetValue) {
		if (newSetValue != setValue) {
			NotificationChain msgs = null;
			if (setValue != null)
				msgs = ((InternalEObject)setValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__SET_VALUE, null, msgs);
			if (newSetValue != null)
				msgs = ((InternalEObject)newSetValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__SET_VALUE, null, msgs);
			msgs = basicSetSetValue(newSetValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__SET_VALUE, newSetValue, newSetValue));
	}
	...
	public NotificationChain basicSetTimeValue(TimeValueType newTimeValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__TIME_VALUE, oldTimeValue, newTimeValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTimeValue(TimeValueType newTimeValue) {
		if (newTimeValue != timeValue) {
			NotificationChain msgs = null;
			if (timeValue != null)
				msgs = ((InternalEObject)timeValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__TIME_VALUE, null, msgs);
			if (newTimeValue != null)
				msgs = ((InternalEObject)newTimeValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__TIME_VALUE, null, msgs);
			msgs = basicSetTimeValue(newTimeValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__TIME_VALUE, newTimeValue, newTimeValue));
	}
	...
	public NotificationChain basicSetYearMonthValue(YearMonthValueType newYearMonthValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__YEAR_MONTH_VALUE, oldYearMonthValue, newYearMonthValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setYearMonthValue(YearMonthValueType newYearMonthValue) {
		if (newYearMonthValue != yearMonthValue) {
			...
			if (yearMonthValue != null)
				msgs = ((InternalEObject)yearMonthValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__YEAR_MONTH_VALUE, null, msgs);
			if (newYearMonthValue != null)
				msgs = ((InternalEObject)newYearMonthValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__YEAR_MONTH_VALUE, null, msgs);
			msgs = basicSetYearMonthValue(newYearMonthValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__YEAR_MONTH_VALUE, newYearMonthValue, newYearMonthValue));
	}
	...
	public NotificationChain basicSetYearValue(YearValueType newYearValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__YEAR_VALUE, oldYearValue, newYearValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setYearValue(YearValueType newYearValue) {
		if (newYearValue != yearValue) {
			NotificationChain msgs = null;
			if (yearValue != null)
				msgs = ((InternalEObject)yearValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__YEAR_VALUE, null, msgs);
			if (newYearValue != null)
				msgs = ((InternalEObject)newYearValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ValuePackage.FIELD_TYPE__YEAR_VALUE, null, msgs);
			msgs = basicSetYearValue(newYearValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__YEAR_VALUE, newYearValue, newYearValue));
	}
	...
	public void setPropertyRef(String newPropertyRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.FIELD_TYPE__PROPERTY_REF, oldPropertyRef, propertyRef));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ValuePackage.FIELD_TYPE__STRING_VALUE:
				return basicSetStringValue(null, msgs);
			case ValuePackage.FIELD_TYPE__BAG_VALUE:
				return basicSetBagValue(null, msgs);
			case ValuePackage.FIELD_TYPE__BOOLEAN_VALUE:
				return basicSetBooleanValue(null, msgs);
			case ValuePackage.FIELD_TYPE__COMPLEX_VALUE:
				return basicSetComplexValue(null, msgs);
			case ValuePackage.FIELD_TYPE__COMPOSITE_VALUE:
				return basicSetCompositeValue(null, msgs);
			case ValuePackage.FIELD_TYPE__CONTROLLED_VALUE:
				return basicSetControlledValue(null, msgs);
			case ValuePackage.FIELD_TYPE__CURRENCY_VALUE:
				return basicSetCurrencyValue(null, msgs);
			case ValuePackage.FIELD_TYPE__DATE_VALUE:
				return basicSetDateValue(null, msgs);
			case ValuePackage.FIELD_TYPE__DATE_TIME_VALUE:
				return basicSetDateTimeValue(null, msgs);
			case ValuePackage.FIELD_TYPE__FILE_VALUE:
				return basicSetFileValue(null, msgs);
			case ValuePackage.FIELD_TYPE__INTEGER_VALUE:
				return basicSetIntegerValue(null, msgs);
			case ValuePackage.FIELD_TYPE__ITEM_REFERENCE_VALUE:
				return basicSetItemReferenceValue(null, msgs);
			case ValuePackage.FIELD_TYPE__LOCALIZED_TEXT_VALUE:
				return basicSetLocalizedTextValue(null, msgs);
			case ValuePackage.FIELD_TYPE__MEASURE_QUALIFIED_NUMBER_VALUE:
				return basicSetMeasureQualifiedNumberValue(null, msgs);
			case ValuePackage.FIELD_TYPE__MEASURE_RANGE_VALUE:
				return basicSetMeasureRangeValue(null, msgs);
			case ValuePackage.FIELD_TYPE__MEASURE_SINGLE_NUMBER_VALUE:
				return basicSetMeasureSingleNumberValue(null, msgs);
			case ValuePackage.FIELD_TYPE__NULL_VALUE:
				return basicSetNullValue(null, msgs);
			case ValuePackage.FIELD_TYPE__RATIONAL_VALUE:
				return basicSetRationalValue(null, msgs);
			case ValuePackage.FIELD_TYPE__REAL_VALUE:
				return basicSetRealValue(null, msgs);
			case ValuePackage.FIELD_TYPE__SEQUENCE_VALUE:
				return basicSetSequenceValue(null, msgs);
			case ValuePackage.FIELD_TYPE__SET_VALUE:
				return basicSetSetValue(null, msgs);
			case ValuePackage.FIELD_TYPE__TIME_VALUE:
				return basicSetTimeValue(null, msgs);
			case ValuePackage.FIELD_TYPE__YEAR_MONTH_VALUE:
				return basicSetYearMonthValue(null, msgs);
			case ValuePackage.FIELD_TYPE__YEAR_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ValuePackage.FIELD_TYPE__YEAR_VALUE:
				return getYearValue();
			case ValuePackage.FIELD_TYPE__PROPERTY_REF:
