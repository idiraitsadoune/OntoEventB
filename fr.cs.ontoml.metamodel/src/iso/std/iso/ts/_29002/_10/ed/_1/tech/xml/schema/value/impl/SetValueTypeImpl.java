...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Set Value Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getValueGroup <em>Value Group</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getStringValue <em>String Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getBagValue <em>Bag Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getBooleanValue <em>Boolean Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getComplexValue <em>Complex Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getCompositeValue <em>Composite Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getControlledValue <em>Controlled Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getCurrencyValue <em>Currency Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getDateValue <em>Date Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getDateTimeValue <em>Date Time Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getFileValue <em>File Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getIntegerValue <em>Integer Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getItemReferenceValue <em>Item Reference Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getLocalizedTextValue <em>Localized Text Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getMeasureQualifiedNumberValue <em>Measure Qualified Number Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getMeasureRangeValue <em>Measure Range Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getMeasureSingleNumberValue <em>Measure Single Number Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getNullValue <em>Null Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getRationalValue <em>Rational Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getRealValue <em>Real Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getSequenceValue <em>Sequence Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getSetValue <em>Set Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getTimeValue <em>Time Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getYearMonthValue <em>Year Month Value</em>}</li>
 *   <li>{@link iso.std.iso.ts._29002._10.ed._1.tech.xml.schema.value.impl.SetValueTypeImpl#getYearValue <em>Year Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SetValueTypeImpl extends MinimalEObjectImpl.Container implements SetValueType {
	/**
	...
	protected EClass eStaticClass() {
		return ValuePackage.Literals.SET_VALUE_TYPE;
	}
	...
	public FeatureMap getValueGroup() {
		if (valueGroup == null) {
			valueGroup = new BasicFeatureMap(this, ValuePackage.SET_VALUE_TYPE__VALUE_GROUP);
		}
		return valueGroup;
	}
	...
	public EList<StringValueType> getStringValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__STRING_VALUE);
	}
	...
	public EList<BagValueType> getBagValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__BAG_VALUE);
	}
	...
	public EList<BooleanValueType> getBooleanValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__BOOLEAN_VALUE);
	}
	...
	public EList<ComplexValueType> getComplexValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__COMPLEX_VALUE);
	}
	...
	public EList<CompositeValueType> getCompositeValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__COMPOSITE_VALUE);
	}
	...
	public EList<ControlledValueType> getControlledValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__CONTROLLED_VALUE);
	}
	...
	public EList<CurrencyValueType> getCurrencyValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__CURRENCY_VALUE);
	}
	...
	public EList<DateValueType> getDateValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__DATE_VALUE);
	}
	...
	public EList<DateTimeValueType> getDateTimeValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__DATE_TIME_VALUE);
	}
	...
	public EList<FileValueType> getFileValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__FILE_VALUE);
	}
	...
	public EList<IntegerValueType> getIntegerValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__INTEGER_VALUE);
	}
	...
	public EList<ItemReferenceValueType> getItemReferenceValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__ITEM_REFERENCE_VALUE);
	}
	...
	public EList<LocalizedTextValueType> getLocalizedTextValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__LOCALIZED_TEXT_VALUE);
	}
	...
	public EList<MeasureQualifiedNumberValueType> getMeasureQualifiedNumberValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__MEASURE_QUALIFIED_NUMBER_VALUE);
	}
	...
	public EList<MeasureRangeValueType> getMeasureRangeValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__MEASURE_RANGE_VALUE);
	}
	...
	public EList<MeasureSingleNumberValueType> getMeasureSingleNumberValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__MEASURE_SINGLE_NUMBER_VALUE);
	}
	...
	public EList<NullValueType> getNullValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__NULL_VALUE);
	}
	...
	public EList<RationalValueType> getRationalValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__RATIONAL_VALUE);
	}
	...
	public EList<RealValueType> getRealValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__REAL_VALUE);
	}
	...
	public EList<SequenceValueType> getSequenceValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__SEQUENCE_VALUE);
	}
	...
	public EList<SetValueType> getSetValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__SET_VALUE);
	}
	...
	public EList<TimeValueType> getTimeValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__TIME_VALUE);
	}
	...
	public EList<YearMonthValueType> getYearMonthValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__YEAR_MONTH_VALUE);
	}
	...
	public EList<YearValueType> getYearValue() {
		return getValueGroup().list(ValuePackage.Literals.SET_VALUE_TYPE__YEAR_VALUE);
	}
