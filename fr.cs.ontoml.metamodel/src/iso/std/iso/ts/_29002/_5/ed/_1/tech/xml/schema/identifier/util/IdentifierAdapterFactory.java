...
public class IdentifierAdapterFactory extends AdapterFactoryImpl {
	...
	protected IdentifierSwitch<Adapter> modelSwitch =
		new IdentifierSwitch<Adapter>() {
			@Override
			public Adapter caseIRDISequenceType(IRDISequenceType object) {
				return createIRDISequenceTypeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link iso.std.iso.ts._29002._5.ed._1.tech.xml.schema.identifier.IRDISequenceType <em>IRDI Sequence Type</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link iso.std.iso.ts._29002._5.ed._1.tech.xml.schema.identifier.DocumentRoot <em>Document Root</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
