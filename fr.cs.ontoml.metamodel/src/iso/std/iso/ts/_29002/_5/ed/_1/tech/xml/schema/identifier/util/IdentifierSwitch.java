...
public class IdentifierSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case IdentifierPackage.IRDI_SEQUENCE_TYPE: {
				IRDISequenceType irdiSequenceType = (IRDISequenceType)theEObject;
				T result = caseIRDISequenceType(irdiSequenceType);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>IRDI Sequence Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>IRDI Sequence Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIRDISequenceType(IRDISequenceType object) {
		return null;
	}
