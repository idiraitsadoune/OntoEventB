...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>SIPREFIX Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see iso.std.iso.is._13584._32.ed._1.tech.xml.schema.ontoml.OntomlPackage#getSIPREFIXType()
 * @model extendedMetaData="name='SI_PREFIX_Type'"
 * @generated
 */
public enum SIPREFIXType implements Enumerator {
	...
	/**
	 * An array of all the '<em><b>SIPREFIX Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final SIPREFIXType[] VALUES_ARRAY =
		new SIPREFIXType[] {
			EXA,
			PETA,
			TERA,
	...
	/**
	 * A public read-only list of all the '<em><b>SIPREFIX Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Returns the '<em><b>SIPREFIX Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static SIPREFIXType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			SIPREFIXType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>SIPREFIX Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static SIPREFIXType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			SIPREFIXType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>SIPREFIX Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static SIPREFIXType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private SIPREFIXType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
