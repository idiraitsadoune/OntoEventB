...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>RATIONALTYPE Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link iso.std.iso.is._13584._32.ed._1.tech.xml.schema.ontoml.impl.RATIONALTYPETypeImpl#getValueFormat <em>Value Format</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RATIONALTYPETypeImpl extends ANYTYPETypeImpl implements RATIONALTYPEType {
	/**
	 ...
	 * @generated
	 */
	protected RATIONALTYPETypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return OntomlPackage.eINSTANCE.getRATIONALTYPEType();
	}
	...
	public void setValueFormat(String newValueFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntomlPackage.RATIONALTYPE_TYPE__VALUE_FORMAT, oldValueFormat, valueFormat));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OntomlPackage.RATIONALTYPE_TYPE__VALUE_FORMAT:
