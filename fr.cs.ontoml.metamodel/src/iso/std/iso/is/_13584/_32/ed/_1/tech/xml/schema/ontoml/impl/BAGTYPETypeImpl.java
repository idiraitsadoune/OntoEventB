...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>BAGTYPE Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link iso.std.iso.is._13584._32.ed._1.tech.xml.schema.ontoml.impl.BAGTYPETypeImpl#getBound1 <em>Bound1</em>}</li>
 *   <li>{@link iso.std.iso.is._13584._32.ed._1.tech.xml.schema.ontoml.impl.BAGTYPETypeImpl#getBound2 <em>Bound2</em>}</li>
 *   <li>{@link iso.std.iso.is._13584._32.ed._1.tech.xml.schema.ontoml.impl.BAGTYPETypeImpl#getValueType <em>Value Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BAGTYPETypeImpl extends ANYTYPETypeImpl implements BAGTYPEType {
	/**
	...
	protected EClass eStaticClass() {
		return OntomlPackage.eINSTANCE.getBAGTYPEType();
	}
	...
	public void setBound1(BigInteger newBound1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntomlPackage.BAGTYPE_TYPE__BOUND1, oldBound1, bound1));
	}
	...
	public void setBound2(BigInteger newBound2) {
		...
		bound2 = newBound2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntomlPackage.BAGTYPE_TYPE__BOUND2, oldBound2, bound2));
	}
	...
	public NotificationChain basicSetValueType(ANYTYPEType newValueType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OntomlPackage.BAGTYPE_TYPE__VALUE_TYPE, oldValueType, newValueType);
	...
	public void setValueType(ANYTYPEType newValueType) {
		if (newValueType != valueType) {
			...
			if (valueType != null)
				msgs = ((InternalEObject)valueType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OntomlPackage.BAGTYPE_TYPE__VALUE_TYPE, null, msgs);
			if (newValueType != null)
				msgs = ((InternalEObject)newValueType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OntomlPackage.BAGTYPE_TYPE__VALUE_TYPE, null, msgs);
			msgs = basicSetValueType(newValueType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntomlPackage.BAGTYPE_TYPE__VALUE_TYPE, newValueType, newValueType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OntomlPackage.BAGTYPE_TYPE__VALUE_TYPE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OntomlPackage.BAGTYPE_TYPE__BOUND1:
				return getBound1();
			case OntomlPackage.BAGTYPE_TYPE__BOUND2:
				return getBound2();
			case OntomlPackage.BAGTYPE_TYPE__VALUE_TYPE:
				return getValueType();
		}
