...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>DATETIMEDATATYPE Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link iso.std.iso.is._13584._32.ed._1.tech.xml.schema.ontoml.impl.DATETIMEDATATYPETypeImpl#getValueFormat <em>Value Format</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DATETIMEDATATYPETypeImpl extends ANYTYPETypeImpl implements DATETIMEDATATYPEType {
	/**
	 ...
	 * @generated
	 */
	protected DATETIMEDATATYPETypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return OntomlPackage.eINSTANCE.getDATETIMEDATATYPEType();
	}
	...
	public void setValueFormat(String newValueFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntomlPackage.DATETIMEDATATYPE_TYPE__VALUE_FORMAT, oldValueFormat, valueFormat));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OntomlPackage.DATETIMEDATATYPE_TYPE__VALUE_FORMAT:
