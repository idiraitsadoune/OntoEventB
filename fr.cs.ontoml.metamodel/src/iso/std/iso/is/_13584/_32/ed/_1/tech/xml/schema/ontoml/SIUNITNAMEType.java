...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>SIUNITNAME Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see iso.std.iso.is._13584._32.ed._1.tech.xml.schema.ontoml.OntomlPackage#getSIUNITNAMEType()
 * @model extendedMetaData="name='SI_UNIT_NAME_Type'"
 * @generated
 */
public enum SIUNITNAMEType implements Enumerator {
	...
	/**
	 * The '<em><b>DEGREECELSIUS</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #DEGREECELSIUS_VALUE
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The '<em><b>DEGREECELSIUS</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>DEGREECELSIUS</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #DEGREECELSIUS
	 * @model literal="DEGREE_CELSIUS"
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * An array of all the '<em><b>SIUNITNAME Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final SIUNITNAMEType[] VALUES_ARRAY =
		new SIUNITNAMEType[] {
			METRE,
			GRAM,
			SECOND,
	...
	/**
	 * A public read-only list of all the '<em><b>SIUNITNAME Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Returns the '<em><b>SIUNITNAME Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static SIUNITNAMEType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			SIUNITNAMEType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>SIUNITNAME Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static SIUNITNAMEType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			SIUNITNAMEType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>SIUNITNAME Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static SIUNITNAMEType get(int value) {
		switch (value) {
			...
			case DEGREECELSIUS_VALUE: return DEGREECELSIUS;
	 ...
	 * @generated
	 */
	private SIUNITNAMEType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
