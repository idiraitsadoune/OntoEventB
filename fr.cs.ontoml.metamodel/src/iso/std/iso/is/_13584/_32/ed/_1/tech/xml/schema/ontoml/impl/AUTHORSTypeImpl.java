 ...
 * </p>
 * <ul>
 *   <li>{@link iso.std.iso.is._13584._32.ed._1.tech.xml.schema.ontoml.impl.AUTHORSTypeImpl#getPerson <em>Person</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AUTHORSTypeImpl extends MinimalEObjectImpl.Container implements AUTHORSType {
	...
	protected EClass eStaticClass() {
		return OntomlPackage.eINSTANCE.getAUTHORSType();
	}
	...
	public EList<PERSONType> getPerson() {
		if (person == null) {
			person = new EObjectContainmentEList<PERSONType>(PERSONType.class, this, OntomlPackage.AUTHORS_TYPE__PERSON);
		}
		return person;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OntomlPackage.AUTHORS_TYPE__PERSON:
