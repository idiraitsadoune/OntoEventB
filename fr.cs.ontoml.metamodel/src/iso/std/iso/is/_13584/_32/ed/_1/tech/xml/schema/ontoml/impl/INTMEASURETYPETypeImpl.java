...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>INTMEASURETYPE Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link iso.std.iso.is._13584._32.ed._1.tech.xml.schema.ontoml.impl.INTMEASURETYPETypeImpl#getValueFormat <em>Value Format</em>}</li>
 *   <li>{@link iso.std.iso.is._13584._32.ed._1.tech.xml.schema.ontoml.impl.INTMEASURETYPETypeImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link iso.std.iso.is._13584._32.ed._1.tech.xml.schema.ontoml.impl.INTMEASURETYPETypeImpl#getAlternativeUnits <em>Alternative Units</em>}</li>
 *   <li>{@link iso.std.iso.is._13584._32.ed._1.tech.xml.schema.ontoml.impl.INTMEASURETYPETypeImpl#getUnitId <em>Unit Id</em>}</li>
 *   <li>{@link iso.std.iso.is._13584._32.ed._1.tech.xml.schema.ontoml.impl.INTMEASURETYPETypeImpl#getAlternativeUnitIds <em>Alternative Unit Ids</em>}</li>
 * </ul>
 *
 * @generated
 */
public class INTMEASURETYPETypeImpl extends ANYTYPETypeImpl implements INTMEASURETYPEType {
	 ...
	 * @generated
	 */
	protected INTMEASURETYPETypeImpl() {
		super();
	}
	...
	public void setValueFormat(String newValueFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntomlPackage.INTMEASURETYPE_TYPE__VALUE_FORMAT, oldValueFormat, valueFormat));
	}
	...
	public NotificationChain basicSetUnit(DICUNITType newUnit, NotificationChain msgs) {
		...
		unit = newUnit;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OntomlPackage.INTMEASURETYPE_TYPE__UNIT, oldUnit, newUnit);
	...
	public void setUnit(DICUNITType newUnit) {
		if (newUnit != unit) {
			...
			if (unit != null)
				msgs = ((InternalEObject)unit).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OntomlPackage.INTMEASURETYPE_TYPE__UNIT, null, msgs);
			if (newUnit != null)
				msgs = ((InternalEObject)newUnit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OntomlPackage.INTMEASURETYPE_TYPE__UNIT, null, msgs);
			msgs = basicSetUnit(newUnit, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntomlPackage.INTMEASURETYPE_TYPE__UNIT, newUnit, newUnit));
	}
	...
	public NotificationChain basicSetAlternativeUnits(ALTERNATIVEUNITSType newAlternativeUnits, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OntomlPackage.INTMEASURETYPE_TYPE__ALTERNATIVE_UNITS, oldAlternativeUnits, newAlternativeUnits);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAlternativeUnits(ALTERNATIVEUNITSType newAlternativeUnits) {
		if (newAlternativeUnits != alternativeUnits) {
			...
			if (alternativeUnits != null)
				msgs = ((InternalEObject)alternativeUnits).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OntomlPackage.INTMEASURETYPE_TYPE__ALTERNATIVE_UNITS, null, msgs);
			if (newAlternativeUnits != null)
				msgs = ((InternalEObject)newAlternativeUnits).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OntomlPackage.INTMEASURETYPE_TYPE__ALTERNATIVE_UNITS, null, msgs);
			msgs = basicSetAlternativeUnits(newAlternativeUnits, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntomlPackage.INTMEASURETYPE_TYPE__ALTERNATIVE_UNITS, newAlternativeUnits, newAlternativeUnits));
	}
	...
	public NotificationChain basicSetUnitId(DICUNITREFERENCEType newUnitId, NotificationChain msgs) {
		...
		unitId = newUnitId;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OntomlPackage.INTMEASURETYPE_TYPE__UNIT_ID, oldUnitId, newUnitId);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setUnitId(DICUNITREFERENCEType newUnitId) {
		if (newUnitId != unitId) {
			NotificationChain msgs = null;
			if (unitId != null)
				msgs = ((InternalEObject)unitId).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OntomlPackage.INTMEASURETYPE_TYPE__UNIT_ID, null, msgs);
			if (newUnitId != null)
				msgs = ((InternalEObject)newUnitId).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OntomlPackage.INTMEASURETYPE_TYPE__UNIT_ID, null, msgs);
			msgs = basicSetUnitId(newUnitId, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntomlPackage.INTMEASURETYPE_TYPE__UNIT_ID, newUnitId, newUnitId));
	}
	...
	public NotificationChain basicSetAlternativeUnitIds(DICUNITSREFERENCEType newAlternativeUnitIds, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OntomlPackage.INTMEASURETYPE_TYPE__ALTERNATIVE_UNIT_IDS, oldAlternativeUnitIds, newAlternativeUnitIds);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAlternativeUnitIds(DICUNITSREFERENCEType newAlternativeUnitIds) {
		if (newAlternativeUnitIds != alternativeUnitIds) {
			...
			if (alternativeUnitIds != null)
				msgs = ((InternalEObject)alternativeUnitIds).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OntomlPackage.INTMEASURETYPE_TYPE__ALTERNATIVE_UNIT_IDS, null, msgs);
			if (newAlternativeUnitIds != null)
				msgs = ((InternalEObject)newAlternativeUnitIds).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OntomlPackage.INTMEASURETYPE_TYPE__ALTERNATIVE_UNIT_IDS, null, msgs);
			msgs = basicSetAlternativeUnitIds(newAlternativeUnitIds, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntomlPackage.INTMEASURETYPE_TYPE__ALTERNATIVE_UNIT_IDS, newAlternativeUnitIds, newAlternativeUnitIds));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OntomlPackage.INTMEASURETYPE_TYPE__UNIT:
				return basicSetUnit(null, msgs);
			case OntomlPackage.INTMEASURETYPE_TYPE__ALTERNATIVE_UNITS:
				return basicSetAlternativeUnits(null, msgs);
			case OntomlPackage.INTMEASURETYPE_TYPE__UNIT_ID:
				return basicSetUnitId(null, msgs);
			case OntomlPackage.INTMEASURETYPE_TYPE__ALTERNATIVE_UNIT_IDS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OntomlPackage.INTMEASURETYPE_TYPE__VALUE_FORMAT:
