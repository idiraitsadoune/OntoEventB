...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>PLACEMENTTYPE Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link iso.std.iso.is._13584._32.ed._1.tech.xml.schema.ontoml.impl.PLACEMENTTYPETypeImpl#getClassRef <em>Class Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PLACEMENTTYPETypeImpl extends ANYTYPETypeImpl implements PLACEMENTTYPEType {
	/**
	 ...
	 * @generated
	 */
	protected PLACEMENTTYPETypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return OntomlPackage.eINSTANCE.getPLACEMENTTYPEType();
	}
	...
	public void setClassRef(String newClassRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntomlPackage.PLACEMENTTYPE_TYPE__CLASS_REF, oldClassRef, classRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OntomlPackage.PLACEMENTTYPE_TYPE__CLASS_REF:
				return getClassRef();
		}
