 ...
 * </p>
 * <ul>
 *   <li>{@link iso.std.iso.is._13584._32.ed._1.tech.xml.schema.ontoml.impl.MESSAGETypeImpl#getCode <em>Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MESSAGETypeImpl extends EXTERNALRESOURCETypeImpl implements MESSAGEType {
	...
	public void setCode(String newCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntomlPackage.MESSAGE_TYPE__CODE, oldCode, code));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OntomlPackage.MESSAGE_TYPE__CODE:
				return getCode();
		}
