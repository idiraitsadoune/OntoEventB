...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>REALTYPE Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link iso.std.iso.is._13584._32.ed._1.tech.xml.schema.ontoml.impl.REALTYPETypeImpl#getValueFormat <em>Value Format</em>}</li>
 * </ul>
 *
 * @generated
 */
public class REALTYPETypeImpl extends ANYTYPETypeImpl implements REALTYPEType {
	/**
	...
	protected EClass eStaticClass() {
		return OntomlPackage.eINSTANCE.getREALTYPEType();
	}
	...
	public void setValueFormat(String newValueFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntomlPackage.REALTYPE_TYPE__VALUE_FORMAT, oldValueFormat, valueFormat));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OntomlPackage.REALTYPE_TYPE__VALUE_FORMAT:
