...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>SYNONYMOUSNAMELABEL Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link iso.std.iso.is._13584._32.ed._1.tech.xml.schema.ontoml.impl.SYNONYMOUSNAMELABELTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link iso.std.iso.is._13584._32.ed._1.tech.xml.schema.ontoml.impl.SYNONYMOUSNAMELABELTypeImpl#getCountryCode <em>Country Code</em>}</li>
 *   <li>{@link iso.std.iso.is._13584._32.ed._1.tech.xml.schema.ontoml.impl.SYNONYMOUSNAMELABELTypeImpl#getLanguageCode <em>Language Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SYNONYMOUSNAMELABELTypeImpl extends MinimalEObjectImpl.Container implements SYNONYMOUSNAMELABELType {
	 ...
	 * @generated
	 */
	protected SYNONYMOUSNAMELABELTypeImpl() {
		super();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntomlPackage.SYNONYMOUSNAMELABEL_TYPE__VALUE, oldValue, value));
	}
	...
	public void setCountryCode(String newCountryCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntomlPackage.SYNONYMOUSNAMELABEL_TYPE__COUNTRY_CODE, oldCountryCode, countryCode));
	}
	...
	public void setLanguageCode(String newLanguageCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntomlPackage.SYNONYMOUSNAMELABEL_TYPE__LANGUAGE_CODE, oldLanguageCode, languageCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OntomlPackage.SYNONYMOUSNAMELABEL_TYPE__VALUE:
				return getValue();
			case OntomlPackage.SYNONYMOUSNAMELABEL_TYPE__COUNTRY_CODE:
				return getCountryCode();
			case OntomlPackage.SYNONYMOUSNAMELABEL_TYPE__LANGUAGE_CODE:
