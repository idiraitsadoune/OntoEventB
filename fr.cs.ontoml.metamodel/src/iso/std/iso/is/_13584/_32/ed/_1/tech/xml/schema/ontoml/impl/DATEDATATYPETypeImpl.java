...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>DATEDATATYPE Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link iso.std.iso.is._13584._32.ed._1.tech.xml.schema.ontoml.impl.DATEDATATYPETypeImpl#getValueFormat <em>Value Format</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DATEDATATYPETypeImpl extends ANYTYPETypeImpl implements DATEDATATYPEType {
	/**
	 ...
	 * @generated
	 */
	protected DATEDATATYPETypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return OntomlPackage.eINSTANCE.getDATEDATATYPEType();
	}
	...
	public void setValueFormat(String newValueFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntomlPackage.DATEDATATYPE_TYPE__VALUE_FORMAT, oldValueFormat, valueFormat));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OntomlPackage.DATEDATATYPE_TYPE__VALUE_FORMAT:
