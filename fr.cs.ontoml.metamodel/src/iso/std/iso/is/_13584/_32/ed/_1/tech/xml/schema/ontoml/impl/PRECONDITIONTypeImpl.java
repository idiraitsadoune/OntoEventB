 ...
 * </p>
 * <ul>
 *   <li>{@link iso.std.iso.is._13584._32.ed._1.tech.xml.schema.ontoml.impl.PRECONDITIONTypeImpl#getFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PRECONDITIONTypeImpl extends MinimalEObjectImpl.Container implements PRECONDITIONType {
	...
	protected EClass eStaticClass() {
		return OntomlPackage.eINSTANCE.getPRECONDITIONType();
	}
	...
	public EList<FILTERType> getFilter() {
		if (filter == null) {
			filter = new EObjectContainmentEList<FILTERType>(FILTERType.class, this, OntomlPackage.PRECONDITION_TYPE__FILTER);
		}
		return filter;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OntomlPackage.PRECONDITION_TYPE__FILTER:
